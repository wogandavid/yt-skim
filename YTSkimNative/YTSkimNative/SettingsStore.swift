...
final class SettingsStore {
  ...
  private enum Key {
    ...
    static let showDockIconDebug = "showDockIconDebug"
  }
  ...
  var showDockIconDebug: Bool {
    get {
      defaults.bool(forKey: Key.showDockIconDebug)
    }
    set {
      defaults.set(newValue, forKey: Key.showDockIconDebug)
    }
  }
}
